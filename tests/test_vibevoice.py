...
from bertytype.stt import vibevoice
...
def test_transcribe_returns_assembled_text():
    ...
    with patch("bertytype.stt.vibevoice.requests.post", return_value=mock_resp):
...
def test_transcribe_sends_wav_as_base64():
    ...
    with patch("bertytype.stt.vibevoice.requests.post", return_value=mock_resp) as mock_post:
